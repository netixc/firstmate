...
# profile rules, primary config/crew-harness=opencode makes a secondmate's
# crewmates spawn on opencode too, primary config/backlog-backend=manual makes that home
