...
# Codex and Cursor. Cursor delivers the same .tool_input.command shape with
# tool_name "Shell" (verified live, cursor-agent 2026.08.11-e8db854), and
# --cursor selects Cursor's own deny rendering.
