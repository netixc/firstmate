...
# bin/fm-wake-lib.sh for its block decision. bin/fm-guard.sh uses Pi's
# fm_watcher_supervision_verdict (also in bin/fm-wake-lib.sh), which requires a
# live identity-matched watcher and retains beacon-age details for messages.
