...
#   missing, malformed, gen-mismatch, source-mismatch,
...
#      muse session-log pull source, then the Grok/Rovo/AGY temporary regex
#      fallbacks classify a grok, rovo, or agy
...
fm_busy_classify() {  # <backend> <target> <harness> <id> <state-dir> [tail40]
  ...
  case "$harness" in
    ...
    rovo*)
      ...
      # definitive idle - matching the muse arm above.
