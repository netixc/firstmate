...
# it fires at the turn boundary where the next cycle must already be live. The
# pull warning (bin/fm-guard.sh) fires mid-turn, so it wants a different,
# model-aware question:
...
#   persistent  every other harness (codex foreground checkpoint, opencode
