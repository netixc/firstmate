...
# family only. Pi can run models from several providers - for example, xAI,
# Anthropic, or other models - so a
...
# Multi-provider Pi maps to its primary family only; see
