...
# Unsupported legacy metadata remains unclassified; Herdr tasks use the shared capture path.
...
# owner (bin/fm-busy-lib.sh), as "<busy|idle|unknown> <source>". Plain Pi
# answers from its lifecycle record; a herdr crew's native `busy` is accepted
