...
Report only true captain-relevant outcomes or a declared external wait by appending one line:
   `echo "{state}: {one short line}" >> '/Users/control/.no-mistakes/evidence/01M0F6FXAGHM6VAQC9WQ2NTQS7/browser-policy-home/state/evidence-secondmate.status'`
