...
pe_register "$HD" lavish argv-src -- "$BLOCKER" "$TRIG3" "one arg with spaces" "second; rm -rf /tmp/fm-procevent-shell-sentinel-01M08NYGXZJQ3MVMQSWK13VX66" >/dev/null
...
assert_grep 'second; rm -rf /tmp/fm-procevent-shell-sentinel-01M08NYGXZJQ3MVMQSWK13VX66' "$R" "a shell-looking argument is passed literally, never interpreted"
assert_absent /tmp/fm-procevent-shell-sentinel-01M08NYGXZJQ3MVMQSWK13VX66 "no shell interpretation occurred"
