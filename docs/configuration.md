...
The tracked repository root also reserves `scratchpad/` for gitignored local working material; directories with that name below the root are not covered by this ignore rule.
