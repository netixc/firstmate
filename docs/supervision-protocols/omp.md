...
The Pi supervision branch (`docs/pi-supervision-branch.md`) is out of scope for the omp primary: every actionable wake is delivered to this conversation, and the lease, outcome-store, and `fm_branch_processed` contracts do not apply here.
