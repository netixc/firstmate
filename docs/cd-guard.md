...
Real Pi evidence is refreshed through `FM_PI_PRIMARY_LIVE_E2E=1 tests/fm-pi-primary-live-e2e.test.sh` and recorded in [`verification/supervision.md`](verification/supervision.md).
