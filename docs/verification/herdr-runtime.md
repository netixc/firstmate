...
pi 2045 9
agents 562
added=6142 deleted=31880 net=-25738
```

The baseline was 157,204 tracked lines, including 55,808 in `bin/`, 80,837 in `tests/`, 2,044 in Pi extensions, and 563 in `AGENTS.md`; the final tree is 25,738 lines smaller.
