...
pi 2045 9
agents 562
added=6025 deleted=31885 net=-25860
```

The baseline was 157,204 tracked lines, including 55,808 in `bin/`, 80,837 in `tests/`, 2,044 in Pi extensions, and 563 in `AGENTS.md`; the final tree is 25,860 lines smaller.
