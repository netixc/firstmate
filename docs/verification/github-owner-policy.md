...
The portable regression also proves that divergent explicit `remote.origin.pushurl` and effective `url.*.pushInsteadOf` destinations are refused before a caller can mutate them.
