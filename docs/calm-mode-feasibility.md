...
The canonical encoder and every non-Pi delivery path remain unchanged, and the Herdr runtime surface continues to transport the same input selected by the harness adapter.
