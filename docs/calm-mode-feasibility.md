...
The canonical encoder and every non-Pi delivery path remain unchanged, and the Herdr and explicit Orca runtime surfaces continue to transport the same input selected by the harness adapter.
