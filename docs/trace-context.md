...
The injection sits at the unconditional pre-launch export site, so it covers ship, scout, and secondmate spawns identically across Claude Code, Codex CLI, Grok, and Pi.
