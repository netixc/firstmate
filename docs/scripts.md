...
| `fm-github-owner-policy.sh` | Verify matching origin fetch and push destinations through fresh canonical GitHub identity, then emit the repository for bound personal-edition PR or issue creation |
