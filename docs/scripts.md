...
| `fm-update.sh`           | Fast-forward-only self-update of firstmate and eligible local or remote secondmate homes, classifying every live mate left on the target commit for restart or fallback nudge |
