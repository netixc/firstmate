...
That keeps spawn launch compatible across codex, opencode, pi, pi-signed, grok, kimi, gemini, rovo, and agy while preserving the requested profile for later audit.
