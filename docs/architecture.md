...
In the personal edition, generated GitHub delivery contracts route pre-mutation repository identity through `bin/fm-github-owner-policy.sh`; its header owns the exact verifier contract, while GitLab delivery bypasses this GitHub-only boundary.
