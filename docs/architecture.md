...
That keeps spawn launch compatible across codex, opencode, pi, pi-signed, grok, kimi, gemini, muse, rovo, and agy while preserving the requested profile for later audit.
