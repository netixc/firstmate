...
The active alert is pane-independent so it can reach an unattended captain even when the Herdr pane is unreadable.
The durable marker remains as an additional signal.
