...
Pi exposes a passive callback that fails open at the hook boundary to protect the user session but schedules one bounded follow-up when the predicate blocks.
