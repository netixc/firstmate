...
It is an agent distro, not an app: instructions, skills, scripts, and state conventions that verified Pi runtimes can inhabit and that run across session managers such as tmux, Herdr, and Orca.
