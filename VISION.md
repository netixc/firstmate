...
The experience it creates is a new way of working, built on exact plain Pi while remaining orthogonal to the captain's session manager.
It is an agent distro, not an app: instructions, skills, scripts, and state conventions that Pi can inhabit across session managers such as tmux, Herdr, and Orca.
