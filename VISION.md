...
It is an agent distro, not an app: instructions, skills, scripts, and state conventions that any verified harness can inhabit - Pi, OpenCode, and others - and that run across session managers such as tmux, Herdr, and Orca.
