...
test_opencode_plugin_delivers_exact_nudge_once() {
  ...
  cp "$ROOT/bin/fm-sessionstart-nudge.sh" "$ROOT/bin/fm-primary-scope-lib.sh" \
    "$ROOT/bin/fm-gate-refuse-lib.sh" "$ROOT/bin/fm-host-platform-lib.sh" \
...
test_pi_large_sessionstart_digest_is_delivered_loudly() {
  ...
  cp "$ROOT/.pi/extensions/lib/fm-host-platform.ts" "$ROOT/.pi/extensions/lib/fm-operational-input.ts" \
    "$ROOT/.pi/extensions/lib/fm-sessionstart-supervisor.mjs" "$fixture/.pi/extensions/lib/"
  cp "$ROOT/bin/fm-host-platform-lib.sh" "$ROOT/bin/fm-sessionstart-run.sh" "$ROOT/bin/fm-sessionstart-nudge.sh" \
