...
# repos with fake `no-mistakes` (run-step source) and native Herdr pane state:
...
# A fakebin with fake `no-mistakes` run output and a native Herdr pane.
# The fake no-mistakes mirrors the real
...
case "${1:-}" in
  ...
  server)
    exit 0 ;;
  session)
    [ "${2:-}" = list ] && printf '%s\n' '{"sessions":[{"name":"lab","running":true,"socket_path":"/tmp/fm-crew-state-lab.sock"}]}' ;;
  workspace)
    case "${2:-}" in
  ...
  tab)
    case "${2:-}" in
      list) printf '{"result":{"tabs":[{"tab_id":"w1:t2","workspace_id":"w1","label":"fm-%s"}]}}\n' "$task_id" ;;
      get) printf '{"result":{"tab":{"tab_id":"w1:t2","workspace_id":"w1","label":"fm-%s"}}}\n' "$task_id" ;;
    esac ;;
  pane)
    case "${2:-}" in
      get)
...
make_no_timeout_toolbin() {  # <dir> -> echoes toolbin path
  ...
  mkdir -p "$tb"
  for tool in bash git grep sed head cut tail dirname basename jq perl; do
...
run_crew_state() {  # <case-dir> <id>
  local resolved
  resolved=$(PATH="$1/fakebin:$PATH" command -v herdr)
  [ "$resolved" = "$1/fakebin/herdr" ] \
    || fail "crew-state fixture resolved operator Herdr instead of $1/fakebin/herdr: $resolved"
...
reset_fakes() {
  ...
  FM_FAKE_HERDR_AGENT_STATUS=""
  FM_FAKE_CI_LOGS=""
  export FM_FAKE_AXI_STATUS FM_FAKE_AXI_STATUS_RUN FM_FAKE_RUNS_LIST FM_FAKE_BUSY FM_FAKE_BUSY_TEXT FM_FAKE_HERDR_MISSING
...
test_active_run_is_authoritative() {
  ...
  fm_write_herdr_task_meta "$d/state/feat-a.meta" "window=fm:fm-feat-a" "worktree=$d/wt" "kind=ship"
...
test_stale_needs_decision_superseded() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-b.meta" "window=fm:fm-feat-b" "worktree=$d/wt" "kind=ship"
...
test_stale_blocked_superseded() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-bb.meta" "window=fm:fm-feat-bb" "worktree=$d/wt" "kind=ship"
...
test_genuine_parked_not_superseded() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-c.meta" "window=fm:fm-feat-c" "worktree=$d/wt" "kind=ship"
...
test_scalar_gate_parked_not_superseded() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-cs.meta" "window=fm:fm-feat-cs" "worktree=$d/wt" "kind=ship"
...
test_gate_block_parked_not_superseded() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-cb.meta" "window=fm:fm-feat-cb" "worktree=$d/wt" "kind=ship"
...
test_ci_ready_done_log_beats_monitoring_run() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-ci.meta" "window=fm:fm-feat-ci" "worktree=$d/wt" "kind=ship"
...
test_ci_monitoring_checks_green_surfaces_done() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-cigreen.meta" "window=fm:fm-feat-cigreen" "worktree=$d/wt" "kind=ship"
...
test_top_level_ci_checks_green_surfaces_done() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-topcigreen.meta" "window=fm:fm-feat-topcigreen" "worktree=$d/wt" "kind=ship"
...
test_ci_monitoring_no_checks_terminal_surfaces_done() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-cinochecks.meta" "window=fm:fm-feat-cinochecks" "worktree=$d/wt" "kind=ship"
...
test_ci_monitoring_green_then_rearm_stays_working() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-cirearm.meta" "window=fm:fm-feat-cirearm" "worktree=$d/wt" "kind=ship"
...
test_ci_monitoring_no_checks_yet_stays_working() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-cinochecksyet.meta" "window=fm:fm-feat-cinochecksyet" "worktree=$d/wt" "kind=ship"
...
test_ci_monitoring_still_waiting_stays_working() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-ciwait.meta" "window=fm:fm-feat-ciwait" "worktree=$d/wt" "kind=ship"
...
test_ci_monitoring_green_then_new_issue_stays_working() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-cirelapse.meta" "window=fm:fm-feat-cirelapse" "worktree=$d/wt" "kind=ship"
...
test_ci_ready_done_log_relapse_stays_working() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-cireadyrelapse.meta" "window=fm:fm-feat-cireadyrelapse" "worktree=$d/wt" "kind=ship"
...
test_ci_fixing_after_green_stays_working() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-cifixing.meta" "window=fm:fm-feat-cifixing" "worktree=$d/wt" "kind=ship"
...
test_top_level_fixing_ci_running_after_green_stays_working() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-topfixingci.meta" "window=fm:fm-feat-topfixingci" "worktree=$d/wt" "kind=ship"
...
test_top_level_fixing_done_log_stays_working() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-topfixing.meta" "window=fm:fm-feat-topfixing" "worktree=$d/wt" "kind=ship"
...
test_terminal_passed() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-d.meta" "window=fm:fm-feat-d" "worktree=$d/wt" "kind=ship"
...
test_terminal_failed() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-e.meta" "window=fm:fm-feat-e" "worktree=$d/wt" "kind=ship"
...
test_cross_branch_attribution_via_runs_list() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-f.meta" "window=fm:fm-feat-f" "worktree=$d/wt" "kind=ship"
...
test_cross_branch_attribution_picks_most_recent_row() {
  ...
  short=$(git -C "$d/wt" rev-parse --short=7 HEAD)
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-fq.meta" "window=fm:fm-feat-fq" "worktree=$d/wt" "kind=ship"
  FM_FAKE_AXI_STATUS="$(run_running fm/other-crew)"
  FM_FAKE_RUNS_LIST="$(cat <<EOF
  running    fm/other-crew aaaaaaa  2026-07-02 22:10
...
test_coarse_run_does_not_probe_other_branch_ci_log_for_ready_status() {
  ...
  short=$(git -C "$d/wt" rev-parse --short=7 HEAD)
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-coarseready.meta" "window=fm:fm-feat-coarseready" "worktree=$d/wt" "kind=ship"
...
test_other_branch_run_ignored() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-g.meta" "window=fm:fm-feat-g" "worktree=$d/wt" "kind=ship" "harness=pi"
...
test_no_run_busy_pane() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-h.meta" "window=fm:fm-feat-h" "worktree=$d/wt" "kind=ship" "harness=pi"
...
test_no_run_footer_text_alone_is_not_working() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-h2.meta" "window=fm:fm-feat-h2" "worktree=$d/wt" "kind=ship" "harness=pi"
  FM_FAKE_AXI_STATUS=""
  FM_FAKE_RUNS_LIST=""
  FM_FAKE_BUSY=1
...
test_no_run_herdr_unknown_uses_backend_capture() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-herdr.meta" "window=default:w1:p2" "worktree=$d/wt" "kind=ship" \
...
test_no_run_herdr_idle_agent_status_outranked_by_record() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-herdr-idle.meta" "window=default:w1:p3" "worktree=$d/wt" "kind=ship" \
    "backend=herdr" "harness=pi"
...
test_no_run_herdr_idle_agent_status_and_idle_record_stays_idle() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-herdr-stopped.meta" "window=default:w1:p4" "worktree=$d/wt" "kind=ship" \
    "backend=herdr" "harness=pi"
...
test_no_run_idle_pane_uses_log() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-i.meta" "window=fm:fm-feat-i" "worktree=$d/wt" "kind=ship" "harness=pi"
...
test_no_run_idle_pane_uses_keyed_log() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-keyed.meta" "window=fm:fm-feat-keyed" "worktree=$d/wt" "kind=ship" "harness=pi"
...
test_no_run_idle_pane_paused() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-pause.meta" "window=fm:fm-feat-pause" "worktree=$d/wt" "kind=ship" "harness=pi"
...
test_no_run_idle_pane_custom_paused_verb() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-custom-pause.meta" "window=fm:fm-feat-custom-pause" "worktree=$d/wt" "kind=ship" "harness=pi"
...
test_no_run_idle_secondmate_resolved_event_not_state() {
  ...
  mkdir -p "$d/wt"
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/mate.meta" "window=fm:fm-mate" "worktree=$d/wt" "kind=secondmate" "home=$d/wt"
...
test_dead_window_ignores_stale_status_log() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-dead.meta" "window=fm:fm-feat-dead" "worktree=$d/wt" "kind=ship"
...
test_dead_window_still_reports_terminal_run_step() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-dead-done.meta" "window=fm:fm-feat-dead-done" "worktree=$d/wt" "kind=ship"
...
test_dead_window_still_reports_active_run_step() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-dead-act.meta" "window=fm:fm-feat-dead-act" "worktree=$d/wt" "kind=ship"
...
SH
  ...
  fm_write_herdr_task_meta "$d/state/feat-timeout.meta" "window=fm:fm-feat-timeout" "worktree=$d/wt" "kind=ship" \
    "harness=pi"
  FM_FAKE_BUSY=1
...
test_scout_skips_run_lookup() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/scout-j.meta" "window=fm:fm-scout-j" "worktree=$d/wt" "kind=scout" \
    "harness=pi"
...
test_torn_down_worktree() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/gone-k.meta" "window=fm:fm-gone-k" "worktree=$d/no-such-worktree" "kind=ship"
  local out rc
...
test_provably_working_via_runs_list_fallback() {
  ...
  short=$(git -C "$d/wt" rev-parse --short=7 HEAD)
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-provable.meta" "window=fm:fm-feat-provable" "worktree=$d/wt" "kind=ship"
  FM_FAKE_AXI_STATUS="$(run_running fm/other-crew)"
  FM_FAKE_RUNS_LIST="$(cat <<EOF
  running    fm/other-crew aaaaaaa  2026-07-02 22:10
...
test_not_provably_working_when_stopped() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-stopped.meta" "window=fm:fm-feat-stopped" "worktree=$d/wt" "kind=ship"
...
test_historical_same_branch_rewritten_head_not_current() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/wishlist.meta" "window=fm:fm-wishlist" "worktree=$d/wt" "kind=ship" "harness=pi"
...
test_active_run_descendant_fix_head_remains_current() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/pipe.meta" "window=fm:fm-pipe" "worktree=$d/wt" "kind=ship"
...
test_local_advanced_past_run_head_invalidates() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/adv.meta" "window=fm:fm-adv" "worktree=$d/wt" "kind=ship" "harness=pi"
...
test_pipeline_owned_active_run_beats_superseded_failed_row() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-f10.meta" "window=fm:fm-feat-f10" "worktree=$d/wt" "kind=ship"
...
test_failed_run_with_no_later_run_still_surfaces() {
  ...
  short=$(git -C "$d/wt" rev-parse --short=8 HEAD)
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-f10b.meta" "window=fm:fm-feat-f10b" "worktree=$d/wt" "kind=ship"
...
test_coarse_unresolvable_active_row_never_falls_to_older_row() {
  ...
  short=$(git -C "$d/wt" rev-parse --short=8 HEAD)
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-f10c.meta" "window=fm:fm-feat-f10c" "worktree=$d/wt" "kind=ship" "harness=pi"
  FM_FAKE_AXI_STATUS="$(run_running fm/other-crew)"
  FM_FAKE_RUNS_LIST="$(cat <<EOF
...
test_non_pipeline_owned_unresolvable_head_not_attributed() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-f10d.meta" "window=fm:fm-feat-f10d" "worktree=$d/wt" "kind=ship" "harness=pi"
...
test_pipeline_owned_terminal_run_not_exempt() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/feat-f10e.meta" "window=fm:fm-feat-f10e" "worktree=$d/wt" "kind=ship" "harness=pi"
...
test_missing_run_head_falls_back_to_current_state() {
  ...
  make_fakebin "$d" >/dev/null
  fm_write_herdr_task_meta "$d/state/no-head.meta" "window=fm:fm-no-head" "worktree=$d/wt" "kind=ship" "harness=pi"
