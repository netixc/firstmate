...
retired standalone Codex dispatch harness is rejected^{"rules":[{"when":"old Codex CLI config","use":{"harness":"codex"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - unverified harness: codex
