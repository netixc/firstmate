...
# missing-brief check, which is reached before any Herdr or Treehouse side effect,
# so the tests create no panes or worktrees. FM_SPAWN_NO_GUARD=1 keeps them off the
