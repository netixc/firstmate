...
test_opencode_plugin_package_boundary_is_explicit_esm() {
  ...
  mkdir -p "$fixture/../.pi/extensions/lib" "$fixture/../bin"
  cp "$ROOT/.pi/extensions/lib/fm-host-platform.ts" "$fixture/../.pi/extensions/lib/"
...
test_opencode_primary_watch_plugin_uses_effective_state_home() {
  ...
  mkdir -p "$repo/bin" "$home/state" "$home/config"
  cp "$ROOT/bin/fm-host-platform-lib.sh" "$repo/bin/"
  git init -q "$repo"
  : > "$repo/AGENTS.md"
