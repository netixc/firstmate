...
test_supported_backend_endpoint_records_validate() {
  ...
  id=unsupported-task
  fm_write_meta "$dir/home/state/$id.meta" \
    "window=unsupported-target" "endpoint_task_id=$id" "worktree=$dir/worktree" "project=$dir/project" \
    "backend=unsupported-backend"
  if fm_backend_validate_task_endpoint "$dir/home/state/$id.meta" "$id"; then
