...
for tok in harness backend legacy-provider herdr legacy-provider legacy-provider legacy-provider claude codex opencode grok kind ship scout secondmate ; do
  case "$LIB_CODE" in
