...
# Markers today: CLAUDECODE (claude), PI_CODING_AGENT (Pi), and GROK_AGENT
# (Grok).
# Codex has no env marker and uses ancestry only. Without this, a local
