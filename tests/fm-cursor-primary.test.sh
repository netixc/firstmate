...
#   RENDERING   - Cursor-specific pre-tool deny responses.
...
install_scripts() {
  ...
  for f in fm-turnend-guard-cursor.sh fm-turnend-guard.sh fm-sessionstart-cursor.sh \
           ...
           fm-cd-pretool-check.sh fm-primary-scope-lib.sh fm-supervision-lib.sh fm-wake-lib.sh \
