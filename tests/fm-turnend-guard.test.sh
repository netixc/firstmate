...
#
# Each scenario gets its own directory carrying a copy of the guard script
...
install_guard_scripts() {
  ...
  chmod +x "$dir/bin/fm-turnend-guard.sh" "$dir/bin/fm-operational-input.sh" "$dir/bin/fm-supervision-instructions.sh"
}
