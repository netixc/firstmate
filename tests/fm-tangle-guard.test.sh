...
# A fake Herdr CLI reports FM_FAKE_PANE_PATH as the post-acquisition foreground cwd.
# This keeps the isolation assertion hermetic while exercising the real spawn path.
make_spawn_fakebin() {
  local dir=$1 fakebin
