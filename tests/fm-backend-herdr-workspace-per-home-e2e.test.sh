...
herdr_make_test_pi "$TEST_PI_BIN" herdr-workspace-test-pi-ready || fail "could not install the test Pi executable"
...
assert_contains_local "$CM1_CAPTURE" "herdr-workspace-test-pi-ready" "cm1 did not launch the test Pi executable"
...
assert_contains_local "$CM2_CAPTURE" "herdr-workspace-test-pi-ready" "cm2 did not launch the test Pi executable"
