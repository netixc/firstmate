...
EOF
  ...
  fm_write_meta "$home/state/missing-task.meta" \
    "backend=herdr" \
...
test_fixture_snapshot_json() {
  ...
  [ "$ids" = "missing-task,scout-task,secondmate-task,ship-task" ] \
...
test_event_hints_follow_reconciled_current_state() {
  ...
  fm_write_meta "$home/state/active-decision.meta" \
    ...
    "kind=ship" \
    "mode=ship"
  record_pi_idle "$home/state" active-decision
  ...
  fm_write_meta "$home/state/active-blocked.meta" \
    ...
    "kind=ship" \
    "mode=ship"
  record_pi_idle "$home/state" active-blocked
...
EOF
  ...
  fm_write_meta "$home/state/bold-task.meta" \
    ...
    "kind=scout" \
    "mode=scout"
  record_pi_idle "$home/state" bold-task
...
test_view_renders_dead_secondmate_agent_status() {
  ...
  fm_write_secondmate_meta "$home/state/dead-secondmate.meta" \
    "$home/secondmate-home" "firstmate:fm-dead-secondmate" "alpha, beta" pi
...
test_completed_scout_report_is_pointer_not_pending() {
  ...
  fm_write_meta "$home/state/lavish-103.meta" \
    ...
    "kind=scout" \
    "mode=scout"
  record_pi_idle "$home/state" lavish-103
...
test_parked_scout_decision_stays_pending() {
  ...
  fm_write_meta "$home/state/parked-scout.meta" \
    ...
    "kind=scout" \
    "mode=scout"
  record_pi_idle "$home/state" parked-scout
