...
- [docs/supervision-protocols/](docs/supervision-protocols/) - rendered primary-harness watcher protocols for Pi and `pi-signed`, and the unknown-harness fallback.
