...
You talk to a single agent - the first mate - and it runs the crew for you: spawning autonomous agents in visible Herdr tabs, giving each a clean git worktree, supervising them to completion, and handing you finished PRs, approved local merges, or standalone investigation reports.
...
- **A visible crew** - every crewmate works in its own Herdr tab that you can watch or type into; the first mate reconciles.
...
- Herdr, for crew session endpoints.
...
It keeps one compact boundary row per hidden operational follow-up, so a turn that a watcher follow-up started never reads as a second unexplained answer.
...
# clones the project under projects/, and spawns two crewmates in Herdr
...
- [docs/configuration.md](docs/configuration.md) - environment variables, `FM_HOME`, Herdr endpoints, optional X mode, the files you set, and harness support.
- [docs/wedge-alarm.md](docs/wedge-alarm.md) - configure the active alert for an away-mode escalation delivery that gets stuck.
- [docs/herdr-backend.md](docs/herdr-backend.md) - setup, lifecycle, isolation, verification, and known Herdr limitations.
