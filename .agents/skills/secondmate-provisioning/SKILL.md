...
When safe, teardown closes the direct Herdr endpoint, removes the `data/secondmates.md` route, clears the main-home metadata, and removes the retired secondmate home.
