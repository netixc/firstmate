...
Raw launch commands cannot invoke Claude and reject `--dangerously-skip-permissions` regardless of their detected harness; Claude workers must use the verified adapter so its template owns permission policy.
