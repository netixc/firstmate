...
description: >-
  ...
  Contains verified facts for codex, opencode, pi, pi-signed, grok, kimi, rovo, and agy.
...
Rovo and AGY are verified only for crewmate and scout work, never a secondmate or primary.
...
Kimi establishes its unsupported primary boundary in its selected harness reference.
