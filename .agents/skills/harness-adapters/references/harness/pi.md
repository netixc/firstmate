...
`bin/fm-spawn.sh` pins the concrete `pi` executable and uses regular TUI mode when supported.
...
The extension listens for Pi's semantic lifecycle and turn-end events.
